...
<div class="row">
    ...
    <!-- Warranty Card -->
    <div class="col-md-4">
        <div class="card card-outline card-<?= $vivienda['garantia_labor'] === 'activa' ? 'success' : ($vivienda['garantia_labor'] === 'por_vencer' ? 'warning' : 'danger') ?>">
            <div class="card-header">
                <h3 class="card-title">
            ...
            <div class="card-body text-center">
                ...
                ?>
                <div class="badge bg-<?= $laborClass ?> fs-5 px-4 py-2 mb-3">
                    <?= $laborText ?>
                </div>
                <table class="table table-sm table-bordered mt-2">
                    ...
                    <tr>
                        <th>Vencimiento</th>
                        <td><?= date('d/m/Y', strtotime($vivienda['vencimiento_labor'])) ?></td>
                    </tr>
                    <tr>
                        <th>Días</th>
                        <td>
                            <?php if ($vivienda['dias_labor'] > 0): ?>
                            <span class="text-<?= $laborClass ?>">
                                <?= $vivienda['dias_labor'] ?> días restantes
                            </span>
                            <?php else: ?>
                            <span class="text-danger">
                                Vencida hace <?= abs($vivienda['dias_labor']) ?> días
                            </span>
                            <?php endif; ?>
                        </td>
                    </tr>
        ...
        <div class="card card-outline card-<?= $vivienda['garantia_equipamiento'] === 'activa' ? 'success' : ($vivienda['garantia_equipamiento'] === 'por_vencer' ? 'warning' : 'danger') ?>">
            <div class="card-header">
                <h3 class="card-title">
            ...
            <div class="card-body text-center">
                ...
                ?>
                <div class="badge bg-<?= $equipClass ?> fs-5 px-4 py-2 mb-3">
                    <?= $equipText ?>
                </div>
                <table class="table table-sm table-bordered mt-2">
                    <tr>
                    ...
                    <tr>
                        <th>Vencimiento</th>
                        <td><?= date('d/m/Y', strtotime($vivienda['vencimiento_equipamiento'])) ?></td>
                    </tr>
                    <tr>
                        <th>Días</th>
                        <td>
                            <?php if ($vivienda['dias_equipamiento'] > 0): ?>
                            <span class="text-<?= $equipClass ?>">
                                <?= $vivienda['dias_equipamiento'] ?> días restantes
                            </span>
                            <?php else: ?>
                            <span class="text-danger">
                                Vencida hace <?= abs($vivienda['dias_equipamiento']) ?> días
                            </span>
                            <?php endif; ?>
                        </td>
                    </tr>
